#!/usr/bin/env python3
"""Module for Neural Style Transfer - Task 10: Variational Cost"""
import numpy as np
...
class NST:
    ...
    def total_cost(self, generated_image):
        ...
        Returns:
            (J, J_content, J_style, J_var) - total, content, style, var costs
        """
    ...
    def compute_grads(self, generated_image):
        ...
        return gradients, J, J_content, J_style, J_var
    ...
    def generate_image(self, iterations=1000, step=None, lr=0.01,
        ...
        for i in range(iterations + 1):
            grads, J, J_content, J_style, J_var = self.compute_grads(
                generated_image)
            if J < best_cost:
                best_cost = J.numpy()
